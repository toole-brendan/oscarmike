...
const Situps: React.FC = () => {
  const [_, navigate] = useLocation();
  const { toast } = useToast();
  
  const exerciseType = 'situps';
  ...
  const calculatePoints = () => {
    ...
    let points = Math.min(100, repCount * 0.8);
        ...
        <Card className="p-6 flex flex-col">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600">
              Complete as many correct sit-ups as possible in the 2-minute time period.
            </p>
          </div>
